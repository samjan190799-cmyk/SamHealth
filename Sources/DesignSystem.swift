...
public struct LocalizationManager {
    public static func tr(_ key: String, lang: String) -> String {
        let translations: [String: [String: String]] = [
            ...
            "nutrition_hint_placeholder": ["ru": "Уточнение (без сахара, соус песто, 1.5 порции)...", "en": "Details (sugar free, pesto sauce, 1.5 portion)...", "hy": "Լրացում (առանց շաքարի, սոուսով)..."],
